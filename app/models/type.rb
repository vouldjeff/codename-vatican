class Type
  ...
  def self.one_by_key(namespace, key, only = nil)
    ...
    response = response.only(:name, :comment, :namespace, :key, "type_properties.values", "type_properties.label", "type_properties.key", "type_properties.expected_type", "type_properties.mediator", "type_properties.unique")
